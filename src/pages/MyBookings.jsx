    ...
    return (
        <div className="py-24 md:py-30 px-4 md:px-16 lg:px-24 xl:px-32">
            <div className="flex flex-col items-start text-left">
                <h1 className="font-playfair text-3xl md:text-[40px]">My Bookings</h1>
                ...
                {bookings.map((booking) => (
                    <div key={booking._id} className="grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t items-center">
                        ...
                        <div className="flex flex-col md:flex-row md:items-center">
                            <img src={booking.room.images[0]} alt="hotel-image" className="w-full md:w-44 rounded shadow object-cover max-w-[220px]" />
                            <div className="flex flex-col gap-1.5 mt-3 md:mt-0 md:ml-4">
                                <p className="font-playfair text-2xl">{booking.hotel.name}
                                    <span className="text-sm font-normal text-gray-600"> ({booking.room.roomType})</span>
                                </p>
