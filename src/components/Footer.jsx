...
const Footer = () => {
    return (
        <>
            <footer className="relative overflow-hidden px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-slate-50 pt-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                    <div className="sm:col-span-2 lg:col-span-1">
                        <a href="/">
                            <img src={assets.logo} className="h-8 md:h-9 invert mb-5 opacity-80" />
                        </a>
                        <p className="text-sm mt-6 font-playfair">
                    ...
                    <div className="flex flex-col lg:items-center lg:justify-center">
                        <div className="flex flex-col font-playfair space-y-2.5">
                            <h2 className="font-semibold mb-5 text-xl text-gray-800">Company</h2>
                    ...
                    <div>
                        <h2 className="font-semibold text-xl text-gray-800 mb-5 font-playfair">Subscribe to our newsletter</h2>
                        <div className="text-xs space-y-6 max-w-sm">
                            <p className="font-playfair text-sm">The latest news, articles, and resources, sent to your inbox weekly.</p>
                            <div className="flex items-center font-playfair gap-2">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-4 border-t mt-6 border-slate-200">
                    <p className="text-center text-sm font-playfair">
                        Copyright 2025 © <a href="https://prebuiltui.com">PrebuiltUI</a> All Right Reserved.
                    </p>
                    <div className="flex items-center text-sm font-playfair gap-4">
